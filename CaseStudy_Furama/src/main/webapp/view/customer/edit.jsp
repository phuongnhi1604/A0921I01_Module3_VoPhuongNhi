            ...
            <form action="/customers?action=edit" method="post">
                    ...
                    <select class="form-select" name="customer_type_id">
                        <c:forEach items="${customerTypeList}" var="customerType">
                            <c:if test="${customerType.getCustomer_type_id() == customer.getCustomer_type_id()}">
                                <option selected value="${customerType.getCustomer_type_id()}">${customerType.getCustomer_type()}</option>
                            </c:if>
                            <c:if test="${customerType.getCustomer_type_id() != customer.getCustomer_type_id()}">
                ...
                <div class="mb-3">
                    ...
                    <c:if test="${customer.isGender()}">
                        <input class="form-check-input" type="radio" name="gender" value="true" checked>Male
                   ...
                   <c:if test="${!customer.isGender()}">
                       ...
                       <input class="form-check-input" type="radio" name="gender" value="false" checked>Female
                   </c:if>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="address" value="<c:out value='${customer.getCustomer_address()}'/>">
                </div>
