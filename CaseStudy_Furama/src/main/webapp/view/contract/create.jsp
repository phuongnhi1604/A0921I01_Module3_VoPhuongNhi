    ...
    <div class="row">
        <div class="col-md-2 mt-3 bg-gradient" style="background-color: #FADA5C">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link a1-color fs-5" href="/contracts">Back to ContractList</a>
                </li>
                <li class="nav-item">
        ...
        <div class="col-md-9 mt-3" style="background-color: #FDF9E4">
            <form action="/contracts?action=add" method="post">
                <div class="mb-3">
                    <c:if test="${mess!=null}">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control w-50" name="startday" placeholder="Enter start day">
                </div>

                <div class="mb-3">
                    <label class="form-label">End day: </label>
                    <input type="date" class="form-control w-50" name="endday" placeholder="Enter end day">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="total" placeholder="Enter total money">
                </div>

                <div class="mb-3">
                    <label class="form-label">Employee_id: </label>
                    <input type="text" class="form-control" name="employee_id" placeholder="Enter Employee_id">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="service_id" placeholder="Enter Service_id">
                </div>
