    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" style="padding-left: 20px" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item mt-3 fs-5">
                    <a class="nav-link " ref="/customers">Customer</a>
                </li>
                <li class="nav-item mt-3 fs-5">
                    <a class="nav-link" href="/services">Service</a>
                </li>
                <li class="nav-item mt-3 fs-5">
                    <a class="nav-link active" aria-current="page" h href="/contracts">Contract</a>
                </li>
            </ul>
    ...
    <div class="row">
        <div class="col-md-2 mt-3 bg-gradient" style="background-color: #FADA5C">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link a1-color fs-5" href="/contractDetails">Back to ContractDetailList</a>
                </li>
                <li class="nav-item">
        ...
        <div class="col-md-9 mt-3" style="background-color: #FDF9E4">
            <form action="/contractDetails?action=add" method="post">
                <div class="mb-3">
                    <c:if test="${mess!=null}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="contract_id" placeholder="Enter contract id">
                </div>

                <div class="mb-3">
                    <label class="form-label">Attach Service ID: </label>
                    <input type="text" class="form-control" name="attach_service_id" placeholder="Enter attach service id">
                </div>
